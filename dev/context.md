...
Generated: 2026-05-26T16:28:54Z
...
8cd79af diag(#54): MA57 head-to-head confirms intrinsic dense-solver limit
48ba725 diag(#54): IR + pivtol-default axes; localize α-window where fix lives
39797ed diag(#54): per-α residual + Identity-scaling axes in α-shift probe
c5c3513 test(probe): α-sweep monotonicity probe for #54 pivot stability
```
